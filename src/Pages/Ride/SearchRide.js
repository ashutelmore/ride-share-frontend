...
export default function SearchRide() {
    ...
    const searchInput = (e) => {
        const searchFieldChanges = e.target.name
        // if (searchFieldChanges == startDate || searchFieldChanges == endDate)

        setSearch({ ...search, [searchFieldChanges]: e.target.value })
    ...
    return (
        <>
            ...
            <div className=" w-full mx-auto z-10 mt-5" >
                                            ...
                                            <div className="flex-auto sm:ml-5 justify-evenly">
                                                ...
                                                <div className="flex pt-2  text-sm text-gray-500">
                                                    ...
                                                    <div className="flex-1 inline-flex items-center">
                                                        ...
                                                        <p className="">Rs. {item.pricePerKM}/km charges</p>
                                                    </div>
                                                    <div className="flex-1 inline-flex items-center">
                                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20"
                                                            fill="currentColor">
