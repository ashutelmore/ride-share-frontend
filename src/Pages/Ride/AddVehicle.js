                ...
                <div className=" pb-12">
                        ...
                        <div className="sm:col-span-3">
                            ...
                            <div className="mt-2">
                                <input
                                    ...
                                    onChange={(e) => setVehicle({ ...vehicle, rcNumber: e.target.value })}
                                />
                            </div>
                            <p className="mt-3 text-sm leading-6 text-left text-gray-600">Required</p>
                        ...
                        <div className="sm:col-span-3 ">
                            ...
                            <div className="mt-2">
                                <input
                                    ...
                                    id="aadharNumber"
                                    className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                    value={vehicle.aadharNumber}
                                    onChange={(e) => setVehicle({ ...vehicle, aadharNumber: e.target.value })}
                                />
                            </div>
                            <p className="mt-3 text-sm leading-6 text-left text-gray-600">Required</p>
                    ...
                    <div className="mt-2 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div className="col-span-full">
                            ...
                            <p className="mt-3 text-sm leading-6 text-left text-gray-600">Optional</p>
                        </div>
